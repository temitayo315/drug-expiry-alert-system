				...
				<div class="container-fluid">
					<form method="POST" action="update_account.php">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" style="width:350px;" value="<?php echo $firstname; ?>" class="form-control" name="fname">
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Lastname:</span>
                            <input type="text" style="width:350px;" value="<?php echo $lastname; ?>" class="form-control" name="lname">
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Phone Number:</span>
                            <input type="text" style="width:350px;" value="<?php echo $phone_number; ?>" class="form-control" name="phone">
                        </div>
						<div class="form-group input-group">
